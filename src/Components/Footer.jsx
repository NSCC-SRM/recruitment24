...
export default function Footer() {
    return (
        <>
            <div id='contact' className='text-white bg-black md:bg-gradient-to-r from-[#124a4a] to-[#000000] flex flex-col md:flex-row md:justify-between md:content-center md:items-center gap-y-10 font-roboto md:px-[170px] w-full pt-5  md:h-[200px]  py-12'>
                ...
                <div className='flex flex-col gap-y-3 md:w-[220px] items-center justify-center pt-12'>
